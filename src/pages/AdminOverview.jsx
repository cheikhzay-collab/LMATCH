  ...
  return (
    <div className="animate-fade-in" style={{ direction: 'ltr', textAlign: 'left' }}>
      ...
      <div className="dashboard-grid stats-row" style={{ marginBottom: '2.5rem' }}>
        ...
        <div className="col-span-3 glass-panel stat-card" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', padding: '1.5rem', gap: '0.5rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', alignItems: 'center' }}>
            <span style={{ fontSize: '0.85rem', fontWeight: 700, color: 'var(--text-muted)' }}>Alertes et Tâches de Contrôle</span>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
              ...
              <select 
                ...
                style={{ padding: '0.4rem 0.8rem', borderRadius: '8px', border: '1px solid var(--border)', background: 'var(--bg-glass)', color: 'var(--text-main)', fontSize: '0.8rem', fontWeight: 700 }}
              >
